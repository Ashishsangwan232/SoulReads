...
//       if (window.innerWidth < 786 && showMenu && sidebarRef.current && !sidebarRef.current.contain(e.target)) {
//         setShowMenu(false);
//       };
//     }
...
//         setShowMenu(true);// Always open on large screens
//       } else {
//         setShowMenu(false);// Closed initially on small screens
//       }
//     };
//     handleResize();
...
//           <aside className={`sidebar ${showMenu || window.innerWidth >= 786 ? 'show' : ''}`} ref={sidebarRef}>
//             {window.innerWidth < 786 && (
//               <span class="material-symbols-outlined" onClick={() => setShowMenu(false)}>
//                 close
//               </span>
//             )}
