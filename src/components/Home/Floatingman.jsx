...
const Floatingman = () => {
    ...
    useEffect(() => {
        const observer = new MutationObserver(() => {
            const newTheme = document.body.classList.contains('blackviolet')
                ? 'blackviolet'
                : 'soulreads-light';
            setTheme(newTheme);
        });
    ...
    const imageSrc =
        theme === 'blackviolet'
            ? '/logo/astronaut2-darktheme.png'
            : '/logo/astronaut3-lighttheme.png';
    return (
        <div className="Floatingcard">
            <img
                ...
                src={imageSrc}
                // src="/logo/astronaut3-lighttheme.png"
                // src="/logo/astronaut2-darktheme.png"
            />
            <div className="floating-heading"></div>
            <div className="floating-icons">
                <a
                    className="floating-instagram"
                    href="https://www.instagram.com/ashish_0.001/"
                    target="_blank"
            ...
            <div className="floating-heading1">Soulreads</div>
        </div>
    );
};
